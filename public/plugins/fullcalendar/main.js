...
var FullCalendar = (function (exports) {
          ...
          for (var n; (g.__r = u.length); )
               (n = u.sort(function (n, l) {
                    ...
                    n.some(function (n) {
                         ...
                         n.__d &&
                              ((r = (o = (l = n).__v).__e),
                              (f = l.__P) && ((u = []), ((i = s({}, o)).__v = o.__v + 1), (t = $(f, o, i, l.__n, void 0 !== f.ownerSVGElement, null != o.__h ? [r] : null, u, null == r ? _(o) : r, o.__h)), j(u, o), t != r && w(o)));
                    });
     }
          ...
          for (s == f && (s = null != r ? r[0] : P ? _(i, 0) : null), u.__k = [], y = 0; y < l.length; y++)
               if (
                    ...
                    (g = $(n, k, (w = w || f), t, o, r, c, s, v)),
                         ...
                         null != g ? (null == m && (m = g), (s = x(n, k, w, A, r, g, s)), v || 'option' != u.type ? 'function' == typeof u.type && (u.__d = s) : (n.value = '')) : s && w.__e == s && s.parentNode != n && (s = _(w));
               }
    ...
    */
     ...
     function isNewPropsValid(newProps, context) {
          ...
          var props = __assign(
               { businessHours: calendarState.businessHours, dateSelection: '', eventStore: calendarState.eventStore, eventUiBases: calendarState.eventUiBases, eventSelection: '', eventDrag: null, eventResize: null },
               newProps
          );
    ...
    */
        ...
        */
          CalendarContent.prototype.render = function () {
               ...
               return createElement(
                    ...
                    createElement(ViewContainer, { liquid: viewVGrow, height: viewHeight, aspectRatio: viewAspectRatio, onClick: this.handleNavLinkClick }, this.renderView(props), this.buildAppendContent()),
     ...
     var TableDateCell = /** @class */ (function (_super) {
          ...
          TableDateCell.prototype.render = function () {
               ...
               return createElement(
                    RenderHook,
                    { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount },
                    function (rootElRef, customClassNames, innerElRef, innerContent) {
                         return createElement(
                              'th',
                              ...
                              createElement(
                                   ...
                                   !dayMeta.isDisabled && createElement('a', __assign({ ref: innerElRef, className: ['fc-col-header-cell-cushion', props.isSticky ? 'fc-sticky' : ''].join(' ') }, navLinkAttrs), innerContent)
                              )
                         );
                    }
               );
               ...
               return createElement(
                    ...
                    function (rootElRef, customClassNames, innerElRef, innerContent) {
                         return createElement(
                              ...
                              createElement('div', { className: 'fc-scrollgrid-sync-inner' }, createElement('a', { className: ['fc-col-header-cell-cushion', props.isSticky ? 'fc-sticky' : ''].join(' '), ref: innerElRef }, innerContent))
                         );
                    }
               );
          };
    ...
    */
     ...
     function renderInnerContent(innerProps) {
          return createElement(
               ...
               createElement('div', { className: 'fc-event-title-container' }, createElement('div', { className: 'fc-event-title fc-sticky' }, innerProps.event.title || createElement(Fragment, null, '\u00A0')))
          );
     }
     ...
     var NowIndicatorRoot = function (props) {
          return createElement(ViewContextType.Consumer, null, function (context) {
               ...
               return createElement(
                    RenderHook,
                    { hookProps: hookProps, classNames: options.nowIndicatorClassNames, content: options.nowIndicatorContent, didMount: options.nowIndicatorDidMount, willUnmount: options.nowIndicatorWillUnmount },
                    props.children
               );
          });
     };
     ...
     var WeekNumberRoot = function (props) {
          return createElement(ViewContextType.Consumer, null, function (context) {
               ...
               return createElement(
                    RenderHook,
                    { hookProps: hookProps, classNames: options.weekNumberClassNames, content: options.weekNumberContent, defaultContent: renderInner$1, didMount: options.weekNumberDidMount, willUnmount: options.weekNumberWillUnmount },
                    props.children
               );
          });
     };
                         ...
                         if (validMutation) {
                              ...
                              if (receivingContext_1 === initialContext_1) {
                                   ...
                                   receivingContext_1.emitter.trigger(
                                        'drop',
                                        __assign(__assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext_1)), { draggedEl: ev.subjectEl, jsEvent: ev.origEvent, view: finalHit.component.context.viewApi })
                                   );
          ...
          TableCell.prototype.render = function () {
               ...
               return createElement(
                    ...
                    function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) {
                         return createElement(
                              'td',
                              __assign({ ref: dayElRef, className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs),
                              createElement(
                                   'div',
                                   ...
                                   createElement(
                                        'div',
                                        { className: 'fc-daygrid-day-events', ref: props.fgContentElRef, style: { paddingBottom: props.fgPaddingBottom } },
                                        props.fgContent,
                                             ...
                                             createElement(
                                                  ...
                                                  createElement(
                                                       ...
                                                       function (rootElRef, classNames, innerElRef, innerContent) {
                                                            return createElement('a', { ref: rootElRef, className: ['fc-daygrid-more-link'].concat(classNames).join(' '), onClick: _this.handleMoreLinkClick }, innerContent);
                                                       }
                                                  )
                                             )
                                   ),
                              ...
                              createElement(
                                   ...
                                   hasListItemDisplay(seg)
                                        ...
                                        : createElement(
                                               TableBlockEvent,
                                               __assign(
                                                    { seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, defaultDisplayEventEnd: defaultDisplayEventEnd },
                         ...
                         props.segs.map(function (seg) {
                              ...
                              return createElement(
                                   ...
                                   hasListItemDisplay(seg)
                                        ...
                                        : createElement(
                                               TableBlockEvent,
                                               __assign({ seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === selectedInstanceId, defaultDisplayEventEnd: false }, getSegMeta(seg, todayRange))
                                          )
                              );
                         })
                    );
     ...
     function TimeColsAxisCell(props) {
          ...
          return createElement(ViewContextType.Consumer, null, function (context) {
               ...
               var dateEnv = context.dateEnv,
                    options = context.options,
                    viewApi = context.viewApi;
               var labelFormat = options.slotLabelFormat == null ? DEFAULT_SLAT_LABEL_FORMAT : Array.isArray(options.slotLabelFormat) ? createFormatter(options.slotLabelFormat[0]) : createFormatter(options.slotLabelFormat); // TODO: fully pre-parse
               var hookProps = {
                    level: 0,
                    time: props.time,
               ...
               return createElement(
                    RenderHook,
                    { hookProps: hookProps, classNames: options.slotLabelClassNames, content: options.slotLabelContent, defaultContent: renderInnerContent$3, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount },
                    function (rootElRef, customClassNames, innerElRef, innerContent) {
                         return createElement(
                              'td',
            ...
            ------------------------------------------------------------------------------------------------------------------*/
               ...
               _this.renderTableRowAxis = function (rowHeight) {
                    ...
                    return (
                         ...
                         createElement(
                              RenderHook,
                              { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount },
                              function (rootElRef, classNames, innerElRef, innerContent) {
                                   return createElement(
                                        'td',
                                        { ref: rootElRef, className: ['fc-timegrid-axis', 'fc-scrollgrid-shrink'].concat(classNames).join(' ') },
          ...
          TimeColsView.prototype.renderHScrollLayout = function (headerRowContent, allDayContent, timeContent, colCnt, dayMinWidth, slatMetas, slatCoords) {
                              ...
                              content: function (arg) {
                                   return (
                                        ...
                                        createElement(
                                             ...
                                             createElement('table', { style: { height: arg.expandRows ? arg.clientHeight : '' } }, arg.tableColGroupNode, createElement('tbody', null, createElement(TimeBodyAxis, { slatMetas: slatMetas }))),
                                             createElement(
                                                  'div',
               ...
               return createElement(ViewRoot, { viewSpec: context.viewSpec, elRef: this.rootElRef }, function (rootElRef, classNames) {
                    return createElement(
                         'div',
                         { className: ['fc-timegrid'].concat(classNames).join(' '), ref: rootElRef },
                         createElement(ScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, colGroups: [{ width: 'shrink', cols: [{ width: 'shrink' }] }, { cols: [{ span: colCnt, minWidth: dayMinWidth }] }], sections: sections })
                    );
               });
          };
          /* Dimensions
     ...
     var TimeCol = /** @class */ (function (_super) {
          ...
          TimeCol.prototype.render = function () {
               ...
               return createElement(DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) {
                    return createElement(
                         'td',
                         __assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
                         createElement(
                              'div',
          ...
          TimeCol.prototype.renderPositionedFgSegs = function (segs, segIsInvisible, isDragging, isResizing, isDateSelecting) {
               ...
               return segs.map(function (seg) {
                    ...
                    return createElement(
                         'div',
                         { className: 'fc-timegrid-event-harness' + (seg.level > 0 ? ' fc-timegrid-event-harness-inset' : ''), key: instanceId, style: __assign({ visibility: segIsInvisible[instanceId] ? 'hidden' : '' }, positionCss) },
                         createElement(
                              TimeColEvent,
                              __assign(
                                   {
          ...
          TimeCol.prototype.renderFillSegs = function (segs, fillType) {
               ...
               var children = segs.map(function (seg) {
                    return createElement(
                         'div',
                         { key: buildEventRangeKey(seg.eventRange), className: 'fc-timegrid-bg-harness', style: _this.computeSegTopBottomCss(seg) },
    ...
    ----------------------------------------------------------------------------------------------------------------------*/
     ...
     var ListViewHeaderRow = /** @class */ (function (_super) {
          ...
          ListViewHeaderRow.prototype.render = function () {
               ...
               return createElement(
                    RenderHook,
                    { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInnerContent$4, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount },
                    function (rootElRef, customClassNames, innerElRef, innerContent) {
                         return createElement(
                              'tr',
                              { ref: rootElRef, className: classNames.concat(customClassNames).join(' '), 'data-date': formatDayString(dayDate) },
                              createElement('th', { colSpan: 3 }, createElement('div', { className: 'fc-list-day-cushion ' + theme.getClass('tableCellShaded'), ref: innerElRef }, innerContent))
                         );
                    }
               );
          };
               ...
               return createElement(
                    ...
                    function (rootElRef, classNames, innerElRef, innerContent, hookProps) {
                         return createElement(
                              ...
                              createElement('td', { className: 'fc-list-event-graphic' }, createElement('span', { className: 'fc-list-event-dot', style: { borderColor: hookProps.borderColor || hookProps.backgroundColor } })),
     ...
     function buildTimeContent(seg, timeFormat, context) {
          ...
          if (options.displayEventTime !== false) {
               ...
               if (doAllDay) {
                    ...
                    return createElement(
                         RenderHook,
                         { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner$1, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount },
                         function (rootElRef, classNames, innerElRef, innerContent) {
    ...
    */
     var ListView = /** @class */ (function (_super) {
          ...
          ListView.prototype.renderEmptyMessage = function () {
               ...
               return createElement(
                    RenderHook,
                    { hookProps: hookProps, classNames: options.noEventsClassNames, content: options.noEventsContent, defaultContent: renderNoEventsInner, didMount: options.noEventsDidMount, willUnmount: options.noEventsWillUnmount },
                    function (rootElRef, classNames, innerElRef, innerContent) {
