                              ...
                              return (
                                   ...
                                   t('LOAD_FILE', function (e, t) {
                                        ...
                                        return new Promise(function (t, r) {
                                             ...
                                             if (null !== s && e.size >= s)
                                                  r({ status: { main: n('GET_LABEL_MAX_FILE_SIZE_EXCEEDED'), sub: i(n('GET_LABEL_MAX_FILE_SIZE'), { filesize: o(s, '.', n('GET_FILE_SIZE_BASE'), n('GET_FILE_SIZE_LABELS', n)) }) } });
                                             else {
                                                  var u = n('GET_MIN_FILE_SIZE');
                                                  if (null !== u && e.size <= u)
                                                       r({ status: { main: n('GET_LABEL_MIN_FILE_SIZE_EXCEEDED'), sub: i(n('GET_LABEL_MIN_FILE_SIZE'), { filesize: o(u, '.', n('GET_FILE_SIZE_BASE'), n('GET_FILE_SIZE_LABELS', n)) }) } });
                                                  else {
                                                       var l = n('GET_MAX_TOTAL_FILE_SIZE');
                                                       if (
                                                            null !== l &&
                                                            n('GET_ACTIVE_ITEMS').reduce(function (e, t) {
                                                                 return e + t.fileSize;
                                                            }, 0) > l
                                                       )
                                                            return void r({
                                                                 status: {
                                                                      ...
                                                                      sub: i(n('GET_LABEL_MAX_TOTAL_FILE_SIZE'), { filesize: o(l, '.', n('GET_FILE_SIZE_BASE'), n('GET_FILE_SIZE_LABELS', n)) }),
                                                                 },
                                                            });
                                                       t(e);
                                                  }
                                                       ...
                                                       u = function () {
                                                            ...
                                                            r({
                                                                 status: {
                                                                      ...
                                                                      sub: o(n('GET_FILE_VALIDATE_TYPE_LABEL_EXPECTED_TYPES'), { allTypes: e.join(', '), allButLastType: e.slice(0, -1).join(', '), lastType: e[e.length - 1] }),
                                                                 },
                                                            });
                                                       };
                                   ...
                                   return (
                                        n('DID_CREATE_ITEM', function (e, t) {
                                             ...
                                             e.extend('setImageCrop', function (t) {
                                                  ...
                                                  e.extend('setImageCropCenter', function (t) {
                                                       if (s(e, n) && u(t)) return c(e, { center: t });
                                                  }),
                                                  e.extend('setImageCropZoom', function (t) {
                                                       if (s(e, n) && l(t)) return c(e, { zoom: Math.max(1, t) });
                                                  }),
                                                  e.extend('setImageCropRotation', function (t) {
                                                       if (s(e, n) && l(t)) return c(e, { rotation: t });
                                                  }),
                                                  e.extend('setImageCropFlip', function (t) {
                                                       if (s(e, n) && u(t)) return c(e, { flip: t });
                                                  }),
                                                  e.extend('setImageCropAspectRatio', function (t) {
                                                       if (s(e, n) && void 0 !== t) {
                                                            var r = e.getMetadata('crop'),
                                                                 i = a(t),
                                                                 o = { center: { x: 0.5, y: 0.5 }, flip: r ? Object.assign({}, r.flip) : { horizontal: !1, vertical: !1 }, rotation: 0, zoom: 1, aspectRatio: i };
                                        ...
                                        n('DID_LOAD_ITEM', function (t, n) {
                                             ...
                                             return new Promise(function (n, i) {
                                                  ...
                                                  t.setMetadata('crop', { center: { x: 0.5, y: 0.5 }, flip: { horizontal: !1, vertical: !1 }, rotation: 0, zoom: 1, aspectRatio: u ? a(u) : null }), n(t);
                                             });
                                        }),
                                        { options: { allowImageCrop: [!0, i.BOOLEAN], imageCropAspectRatio: [null, i.STRING] } }
                                   );
                              };
                         return 'undefined' != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent('FilePond:pluginloaded', { detail: t })), t;
                    })();
               },
               5227: function (e) {
                    e.exports = (function () {
                         ...
                         var e = function (e) {
                              ...
                              t = { JPEG: 65496, APP1: 65505, EXIF: 1165519206, TIFF: 18761, Orientation: 274, Unknown: 65280 },
                              n = function (e, t) {
                                             ...
                                             if (n(o, 0) === t.JPEG) {
                                                  for (var a = o.byteLength, s = 2; s < a; ) {
                                                       ...
                                                       if (((s += 2), u === t.APP1)) {
                                                            ...
                                                            var c = n(o, s, l);
                                                            s += 2;
                                                            for (var f = 0; f < c; f++) if (n(o, s + 12 * f, l) === t.Orientation) return void i(n(o, s + 12 * f + 8, l));
                                                       } else {
                                   ...
                                   return (
                                        n('DID_LOAD_ITEM', function (t, n) {
                                             ...
                                             return new Promise(function (n, o) {
                                                  ...
                                                  i(s).then(function (e) {
                                                       t.setMetadata('exif', { orientation: e }), n(t);
                                                  });
                                             });
                                        }),
                         ...
                         return 'undefined' != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent('FilePond:pluginloaded', { detail: c })), c;
                    })();
               },
               1571: function (e) {
                    e.exports = (function () {
                         ...
                         var e = function (e) {
                              ...
                              t = function (t) {
                                   ...
                                   return (
                                        ...
                                        { options: { allowImageFilter: [!0, r.BOOLEAN], imageFilterColorMatrix: [null, r.ARRAY] } }
                                   );
                              };
                         return 'undefined' != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent('FilePond:pluginloaded', { detail: t })), t;
                    })();
                    ...
                    e.exports = (function () {
                         ...
                         var s = function (e, t) {
                              ...
                              l = function (e) {
                                   ...
                                   return 0 === t ? { x: 0, y: 0 } : f(e.x / t, e.y / t);
                              },
                              c = function (e, t, n) {
                                   var r = Math.cos(t),
                                        i = Math.sin(t),
                              ...
                              h = function (e, t) {
                                   ...
                                   return (
                                        E(i) || (i = E(a) && E(u) ? t.height - a - u : u),
                                        E(r) || (r = E(o) && E(s) ? t.width - o - s : s),
                                        E(o) || (o = E(r) && E(s) ? t.width - r - s : 0),
                                        E(a) || (a = E(i) && E(u) ? t.height - i - u : 0),
                              ...
                              v = function (e) {
                                   var t = e.rect.x + 0.5 * e.rect.width,
                                        ...
                                        r = 0.5 * e.rect.width,
                                        i = 0.5 * e.rect.height;
                                   return m(e, Object.assign({ cx: t, cy: n, rx: r, ry: i }, e.styles));
                              },
                              y = { contain: 'xMidYMid meet', cover: 'xMidYMid slice' },
                              R = function (e, t) {
                                   m(e, Object.assign({}, e.rect, e.styles, { preserveAspectRatio: y[t.fit] || 'none' }));
                              },
                              ...
                              A = function (e, t, n, r) {
                                   ...
                                   m(e, Object.assign({}, e.rect, e.styles, { 'stroke-width': 0, 'font-weight': a, 'font-size': i, 'font-family': o, 'text-anchor': s })),
                              ...
                              D = function (e, t, n, r) {
                                   ...
                                   if ((m(i, { x1: f.x, y1: f.y, x2: p.x, y2: p.y }), t.lineDecoration)) {
                                        ...
                                        if (-1 !== t.lineDecoration.indexOf('arrow-begin')) {
                                             var _ = s(E, h),
                                                  ...
                                                  I = c(f, 2, g),
                                                  T = c(f, -2, g);
                                             m(o, { style: 'display:block;', d: 'M'.concat(I.x, ',').concat(I.y, ' L').concat(f.x, ',').concat(f.y, ' L').concat(T.x, ',').concat(T.y) });
                                        }
                                        if (-1 !== t.lineDecoration.indexOf('arrow-end')) {
                                             var v = s(E, -h),
                                                  ...
                                                  R = c(p, 2, y),
                                                  O = c(p, -2, y);
                                             m(a, { style: 'display:block;', d: 'M'.concat(R.x, ',').concat(R.y, ' L').concat(p.x, ',').concat(p.y, ' L').concat(O.x, ',').concat(O.y) });
                                        }
                                   }
                              },
                              S = function (e, t, n, r) {
                                        ...
                                        Object.assign({}, e.styles, {
                                             ...
                                             d: _(
                                                  t.points.map(function (e) {
                                                       return { x: d(e.x, n, r, 'width'), y: d(e.y, n, r, 'height') };
                                                  })
                                             ),
                                        })
                                   );
                              ...
                              L = function (e) {
                                   var t = I('g', { id: e.id, 'stroke-linecap': 'round', 'stroke-linejoin': 'round' }),
                                        n = I('line');
                                   t.appendChild(n);
                                   var r = I('path');
                                   t.appendChild(r);
                              ...
                              M = {
                                   image: function (e) {
                                        var t = I('image', { id: e.id, 'stroke-linecap': 'round', 'stroke-linejoin': 'round', opacity: '0' });
                                        return (
                                             (t.onload = function () {
                              ...
                              P = { rect: T, ellipse: v, image: R, text: A, path: S, line: D },
                              b = function (e, t) {
                                   return M[e](t);
                              },
                              ...
                              X = function (e, t) {
                                   var n = e.width,
                                        r = n * t;
                                   return r > e.height && (n = (r = e.height) / t), { x: 0.5 * (e.width - n), y: 0.5 * (e.height - r), width: n, height: r };
                              },
                              Z = function (e) {
                                   ...
                                   var a = j(e, o, n),
                                        ...
                                        u = { x: 0, y: 0, width: a.width, height: a.height, center: s },
                                        l = void 0 === t.scaleToFit || t.scaleToFit,
                                        c = n * H(e, X(u, o), r, l ? i : { x: 0.5, y: 0.5 });
                                   return { widthFloat: a.width / c, heightFloat: a.height / c, width: Math.round(a.width / c), height: Math.round(a.height / c) };
                              },
                              Q = { type: 'spring', stiffness: 0.5, damping: 0.45, mass: 10 },
                              K = function (e) {
                                   return e.utils.createView({
                                        name: 'image-bitmap',
                                        ignoreRect: !0,
                              ...
                              $ = function (e) {
                                   return e.utils.createView({
                                        ...
                                        mixins: {
                                             ...
                                             animations: { originX: Q, originY: Q, scaleX: Q, scaleY: Q, translateX: Q, translateY: Q, rotateZ: Q },
                                        },
                                        create: function (t) {
                                             var n = t.root,
                                                  r = t.props;
                                             (r.width = r.image.width), (r.height = r.image.height), (n.ref.bitmap = n.appendChildView(n.createChildView(K(e), { image: r.image })));
                                        },
                                        write: function (e) {
                                             var t = e.root,
                                                  n = e.props.crop.flip,
                              ...
                              J = function (e) {
                                   return e.utils.createView({
                                        ...
                                        create: function (t) {
                                             var n = t.root,
                                                  r = t.props;
                                             (n.ref.image = n.appendChildView(n.createChildView($(e), Object.assign({}, r)))),
                                        ...
                                        write: function (e) {
                                             var t = e.root,
                                                  ...
                                                  l = n.height;
                                             t.ref.image.crop = i;
                                             var c = { x: 0, y: 0, width: u, height: l, center: { x: 0.5 * u, y: 0.5 * l } },
                                                  f = { width: t.ref.image.width, height: t.ref.image.height },
                                                  d = { x: i.center.x * f.width, y: i.center.y * f.height },
                                                  p = { x: c.center.x - f.width * i.center.x, y: c.center.y - f.height * i.center.y },
                                                  E = 2 * Math.PI + (i.rotation % (2 * Math.PI)),
                                                  h = i.aspectRatio || f.height / f.width,
                                                  _ = void 0 === i.scaleToFit || i.scaleToFit,
                                                  m = H(f, X(c, h), E, _ ? i.center : { x: 0.5, y: 0.5 }),
                                                  g = i.zoom * m;
                                             o && o.length
                                                  ? (t.ref.createMarkup(), (t.ref.markup.width = u), (t.ref.markup.height = l), (t.ref.markup.resize = a), (t.ref.markup.dirty = s), (t.ref.markup.markup = o), (t.ref.markup.crop = Z(f, i)))
                              ...
                              ee = function (e) {
                                   return e.utils.createView({
                                        ...
                                        mixins: {
                                             ...
                                             animations: { scaleX: Q, scaleY: Q, translateY: Q, opacity: { type: 'tween', duration: 400 } },
                                        },
                                        create: function (t) {
                                             var n = t.root,
                                                  r = t.props;
                                             n.ref.clip = n.appendChildView(n.createChildView(J(e), { id: r.id, image: r.image, crop: r.crop, markup: r.markup, resize: r.resize, dirty: r.dirty, background: r.background }));
                                        },
                                        write: function (e) {
                                             var t = e.root,
                                                  n = e.props,
                                   ...
                                   self.onmessage = function (e) {
                                        for (
                                             ...
                                             (D = r[A] / 255),
                                                  ...
                                                  (w = r[A + 2] / 255),
                                                  (L = r[A + 3] / 255),
                                                  (r[A] = Math.max(0, Math.min(255 * (D * o + S * a + w * s + L * u + l), 255))),
                                                  (r[A + 1] = Math.max(0, Math.min(255 * (D * c + S * f + w * d + L * p + E), 255))),
                                                  (r[A + 2] = Math.max(0, Math.min(255 * (D * h + S * _ + w * m + L * g + I), 255))),
                                                  (r[A + 3] = Math.max(0, Math.min(255 * (D * T + S * v + w * y + L * R + O), 255)));
                              ...
                              pe = function (e) {
                                   ...
                                   return { r: (u = Ee(u, s)), g: (l = Ee(l, s)), b: (c = Ee(c, s)) };
                              },
                              Ee = function (e, t) {
                                   ...
                                   var t = re(e),
                                        ...
                                        s = function (e) {
                                             ...
                                             if (a) {
                                                  var s,
                                                       u,
                                                       l = a.getMetadata('crop') || { center: { x: 0.5, y: 0.5 }, flip: { horizontal: !1, vertical: !1 }, zoom: 1, rotation: 0, aspectRatio: null },
                                                  ...
                                                  var d = t.appendChildView(
                                                       t.createChildView(n, { id: o, image: i, crop: l, resize: u, markup: s, dirty: f, background: c, opacity: 0, scaleX: 1.15, scaleY: 1.15, translateY: 15 }),
                                                       t.childViews.length
                                                  );
                                                  t.ref.images.push(d),
                                                       (d.opacity = 1),
                                                       ...
                                                       (d.translateY = 0),
                                                       setTimeout(function () {
                                                            t.dispatch('DID_IMAGE_PREVIEW_SHOW', { id: o });
                                                       }, 250);
                                             }
                                        },
                                        u = function (e) {
                                             ...
                                             if (r) {
                                                  ...
                                                  (i.crop = r.getMetadata('crop')),
                                                       (i.background = t.query('GET_IMAGE_TRANSFORM_CANVAS_BACKGROUND_COLOR')),
                                                       t.query('GET_IMAGE_PREVIEW_MARKUP_SHOW') && ((i.dirty = !0), (i.resize = r.getMetadata('resize')), (i.markup = r.getMetadata('markup')));
                                             }
                                        },
                                        l = function (e) {
                                             var t = e.root,
                                             ...
                                             if (/crop|filter|markup|resize/.test(r.change.key) && t.ref.images.length) {
                                                  var o = t.query('GET_ITEM', { id: n.id });
                                                  if (o)
                                                       if (/filter/.test(r.change.key)) {
                                                            ...
                                                            if (c && c.aspectRatio && f.crop && f.crop.aspectRatio && Math.abs(c.aspectRatio - f.crop.aspectRatio) > 1e-5) {
                                                                 var d = a({ root: t });
                                                                 s({ root: t, props: n, image: he(d.image) });
                                        ...
                                        f = function (e) {
                                             ...
                                             if (r) {
                                                  ...
                                                  ae(i, function (e, r) {
                                                       t.dispatch('DID_IMAGE_PREVIEW_CALCULATE_SIZE', { id: n, width: e, height: r });
                                                  });
                                             }
                                        },
                                        d = function (e) {
                                                            ...
                                                            if (o && l) {
                                                                 ...
                                                                 var g = le(e, _, m, r),
                                                                      I = function () {
                                                                           ...
                                                                           a.setMetadata('color', r, !0), 'close' in e && e.close(), (t.ref.overlayShadow.opacity = 1), s({ root: t, props: n, image: g });
                                                                      },
                                        ...
                                        h = function (e) {
                                             var t = e.root;
                                             (t.ref.overlayShadow.opacity = 0.25), (t.ref.overlayError.opacity = 1);
                                        },
                                        _ = function (e) {
                                             var t = e.root;
                                             (t.ref.overlayShadow.opacity = 0.25), (t.ref.overlaySuccess.opacity = 1);
                                        },
                                        m = function (e) {
                                             var n = e.root;
                                             (n.ref.images = []),
                                                  ...
                                                  (n.ref.imageViewBin = []),
                                                  (n.ref.overlayShadow = n.appendChildView(n.createChildView(t, { opacity: 0, status: 'idle' }))),
                                                  (n.ref.overlaySuccess = n.appendChildView(n.createChildView(t, { opacity: 0, status: 'success' }))),
                                                  (n.ref.overlayError = n.appendChildView(n.createChildView(t, { opacity: 0, status: 'failure' })));
                                        };
                                   return e.utils.createView({
                                   ...
                                   return (
                                        n('CREATE_VIEW', function (t) {
                                             ...
                                             if (n('file') && i('GET_ALLOW_IMAGE_PREVIEW')) {
                                                  var u = function (t) {
                                                            ...
                                                            if (u && a(u.file) && !u.archived) {
                                                                 ...
                                                                 if (e(l) && i('GET_IMAGE_PREVIEW_FILTER_ITEM')(u)) {
                                                                      ...
                                                                      if (!(!c && f && l.size > f)) {
                                                                           n.ref.imagePreview = r.appendChildView(r.createChildView(s, { id: o }));
                                                                           var d = n.query('GET_IMAGE_PREVIEW_HEIGHT');
                                                                           d && n.dispatch('DID_UPDATE_PANEL_HEIGHT', { id: u.id, height: d });
                                                                           var p = !c && l.size > i('GET_IMAGE_PREVIEW_MAX_INSTANT_PREVIEW_FILE_SIZE');
                                                                           n.dispatch('DID_IMAGE_PREVIEW_CONTAINER_CREATE', { id: o }, p);
                                                                      }
                                                                 }
                                                            }
                                                       },
                                                                      ...
                                                                      if (!(i || o || a)) {
                                                                           ...
                                                                           if (u && l) {
                                                                                ...
                                                                                var h = l / u,
                                                                                     ...
                                                                                     I = Math.min(g * _, m);
                                                                                e.dispatch('DID_UPDATE_PANEL_HEIGHT', { id: r.id, height: I });
                                                                           }
                                                                      }
                                                                 }
                                                            }
                                                  ...
                                                  r.registerWriter(
                                                       o({ DID_RESIZE_ROOT: c, DID_STOP_RESIZE: c, DID_LOAD_ITEM: u, DID_IMAGE_PREVIEW_CALCULATE_SIZE: d, DID_UPDATE_ITEM_METADATA: f }, function (e) {
                                                            var t = e.root,
                                                                 n = e.props;
                                                            t.ref.imagePreview &&
                                                                 (t.rect.element.hidden ||
                                                                      (t.ref.shouldRescale && (l(t, n), (t.ref.shouldRescale = !1)),
                                                                      t.ref.shouldDrawPreview &&
                                                                           (requestAnimationFrame(function () {
                                                                                requestAnimationFrame(function () {
                                                                                     t.dispatch('DID_FINISH_CALCULATE_PREVIEWSIZE', { id: n.id });
                                                                                });
                                                                           }),
                         ...
                         return 'undefined' != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent('FilePond:pluginloaded', { detail: Ie })), Ie;
                    })();
               },
               3567: function (e) {
                    e.exports = (function () {
                                        ...
                                        r('DID_LOAD_ITEM', function (n, r) {
                                             ...
                                             return new Promise(function (r, o) {
                                                  ...
                                                  t(p, function (e) {
                                                       ...
                                                       n.setMetadata('resize', { mode: s, upscale: c, size: { width: f, height: d } }), r(n);
                                                  });
                                             });
                                        }),
                                        {
                         ...
                         return 'undefined' != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent('FilePond:pluginloaded', { detail: n })), n;
                    })();
               },
               6136: function (e, t) {
                    !(function (e) {
                         ...
                         var t = function (e) {
                              ...
                              n = function (e) {
                                   var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                                        ...
                                        s = function (e, t, n) {
                                             !n || document.hidden ? (f[e] && f[e](t), i.push({ type: e, data: t })) : o.push({ type: e, data: t });
                                        },
                                        u = function (e) {
                              ...
                              c = function (e, t) {
                                   ...
                                   return (
                                        t && (l(e) ? a(r, 'class', t) : (r.className = t)),
                                        i(n, function (e, t) {
                                             a(r, e, t);
                                        }),
                                        r
                              ...
                              m = function (e, t, n, r) {
                                   var i = n[0] || e.left,
                                        ...
                                        a = i + e.width,
                                        s = o + e.height * (r[1] || 1),
                                        u = { element: Object.assign({}, e), inner: { left: e.left, top: e.top, right: e.right, bottom: e.bottom }, outer: { left: i, top: o, right: a, bottom: s } };
                                   return (
                                        t
                                             .filter(function (e) {
                                             ...
                                             E = o({
                                                  interpolate: function (n, r) {
                                                       f ||
                                                            ...
                                                            (null === c && (c = n),
                                                            n - c < l ||
                                                                 ((e = n - c - l) >= i || r ? ((e = 1), (t = d ? 0 : 1), E.onupdate(t * p), E.oncomplete(t * p), (f = !0)) : ((t = e / i), E.onupdate((e >= 0 ? s(d ? 1 - t : t) : 0) * p))));
                                                  },
                                                  target: {
                                                       get: function () {
                                                            return d ? 0 : p;
                              ...
                              A = function (e, t, n) {
                                   ...
                                   (t = Array.isArray(t) ? t : [t]).forEach(function (t) {
                                        e.forEach(function (e) {
                                             ...
                                             'object' == typeof e && ((i = e.key), (o = e.getter || o), (a = e.setter || a)), (t[i] && !r) || (t[i] = { get: o, set: a });
                                        });
                                   });
                              },
                              D = function (e) {
                              ...
                              L = { opacity: 1, scaleX: 1, scaleY: 1, translateX: 0, translateY: 0, rotateX: 0, rotateY: 0, rotateZ: 0, originX: 0, originY: 0 },
                              M = function (e) {
                                   var t = e.mixinConfig,
                                        n = e.viewProps,
                                        r = e.viewInternalAPI,
                              ...
                              b = function (e, t) {
                                   var n = t.opacity,
                                        ...
                                        h = '',
                                        _ = '';
                                   (w(f) || w(d)) && (_ += 'transform-origin: ' + (f || 0) + 'px ' + (d || 0) + 'px;'),
                                        w(r) && (h += 'perspective(' + r + 'px) '),
                                        (w(i) || w(o)) && (h += 'translate3d(' + (i || 0) + 'px, ' + (o || 0) + 'px, 0) '),
                                        (w(a) || w(s)) && (h += 'scale3d(' + (w(a) ? a : 1) + ', ' + (w(s) ? s : 1) + ', 1) '),
                                        w(c) && (h += 'rotateZ(' + c + 'rad) '),
                                        w(u) && (h += 'rotateX(' + u + 'rad) '),
                                        w(l) && (h += 'rotateY(' + l + 'rad) '),
                                        h.length && (_ += 'transform:' + h + ';'),
                                        w(n) && ((_ += 'opacity:' + n + ';'), 0 === n && (_ += 'visibility:hidden;'), n < 1 && (_ += 'pointer-events:none;')),
                                        w(E) && (_ += 'height:' + E + 'px;'),
                                        w(p) && (_ += 'width:' + p + 'px;');
                              ...
                              G = function () {
                                   ...
                                   return function (e) {
                                             ...
                                             k = function (e, n, r) {
                                                  ...
                                                  return (
                                                       w.forEach(function (o) {
                                                            !1 === o({ props: t, root: X, actions: n, timestamp: e, shouldOptimize: r }) && (i = !1);
                                                       }),
                                                       ...
                                                       (g = i),
                                                       S({ props: t, root: X, actions: n, timestamp: e }),
                                                       i
                                                  );
                                             },
                                             Y = function () {
                                        ...
                                        Object.keys(G)
                                             ...
                                             .forEach(function (e) {
                                                  var n = C[e]({ mixinConfig: G[e], viewProps: t, viewState: D, viewInternalAPI: W, viewExternalAPI: j, view: o(H) });
                                                  n && y.push(n);
                                             });
                                        var X = o(W);
                                        I({ root: X, props: t });
                              ...
                              F = function (e, t) {
                                   return function (n) {
                                        ...
                                        a
                                             ...
                                             .forEach(function (t) {
                                                  return e[t.type]({ root: r, props: i, action: t.data, timestamp: s, shouldOptimize: u });
                                             }),
                                             t && t({ root: r, props: i, actions: a, timestamp: s, shouldOptimize: u });
                                   };
                              },
                              U = function (e, t) {
                              ...
                              ee = { process: 'POST', patch: 'PATCH', revert: 'DELETE', fetch: 'GET', restore: 'GET', load: 'GET' },
                              te = function (e) {
                                   var t = {};
                                   return (
                                        (t.url = j(e) ? e : e.url || ''),
                                        ...
                                        (t.process = e.process || j(e) || e.url ? t.process : null),
                              ...
                              ne = function (e, t, n, r, i) {
                                   ...
                                   var o = { url: 'GET' === n || 'PATCH' === n ? '?' + e + '=' : '', method: n, headers: i, withCredentials: !1, timeout: r, onload: null, ondata: null, onerror: null };
                              ...
                              pe = function (e) {
                                   return { items: [], listUpdateTimeout: null, itemUpdateTimeout: null, processingQueue: [], options: de(e) };
                              },
                              Ee = function (e) {
                                   var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '-';
                                   return e
                                   ...
                                   return (
                                        i(t, function (t) {
                                             n[t] = {
                                                  ...
                                                  set: function (n) {
                                                       e.dispatch('SET_' + Ee(t, '_').toUpperCase(), { value: n });
                                                  },
                                             };
                                        }),
                                        n
                                        ...
                                        return (
                                             i(e, function (e) {
                                                  ...
                                                  o['SET_' + n] = function (i) {
                                                       ...
                                                       t('DID_SET_' + n, { value: r.options[e] });
                                                  };
                                             }),
                                             o
                                        );
                              ...
                              ge = { API: 1, DROP: 2, BROWSE: 3, PASTE: 4, NONE: 5 },
                              Ie = function () {
                         ...
                         'function' == typeof Symbol &&
                              Symbol.asyncIterator &&
                              (ve.prototype[Symbol.asyncIterator] = function () {
                                   return this;
                              }),
                         ...
                         var we = function (e, t) {
                              ...
                              Ge = { INIT: 1, IDLE: 2, PROCESSING_QUEUED: 9, PROCESSING: 3, PROCESSING_COMPLETE: 5, PROCESSING_ERROR: 6, PROCESSING_REVERT_ERROR: 10, LOADING: 7, LOAD_ERROR: 8 },
                              xe = { INPUT: 1, LIMBO: 2, LOCAL: 3 },
                              Fe = function (e) {
                                   return /[^0-9]+/.exec(e);
                              },
                              Ue = function () {
                              ...
                              Ve = { BOOLEAN: 'boolean', INT: 'int', NUMBER: 'number', STRING: 'string', ARRAY: 'array', OBJECT: 'object', FUNCTION: 'function', ACTION: 'action', SERVER_API: 'serverapi', REGEX: 'regex' },
                              qe = [],
                              ke = function (e, t, n) {
                              ...
                              Xe = {
                                   ...
                                   ignoredFiles: [['.ds_store', 'thumbs.db', 'desktop.ini'], Ve.ARRAY],
                                   ...
                                   chunkRetryDelays: [[500, 1e3, 3e3], Ve.ARRAY],
                                   ...
                                   labelIdle: ['Seret & Jatuhkan file Anda atau  <span class="filepond--label-action">Jelajahi</span>', Ve.STRING],
                                   ...
                                   files: [[], Ve.ARRAY],
                                   credits: [['https://pqina.nl/', 'Powered by PQINA'], Ve.ARRAY],
                              },
                              Ze = function (e, t) {
                                   return q(t)
                                        ? e[0] || null
                              ...
                              $e = { EMPTY: 0, IDLE: 1, ERROR: 2, BUSY: 3, READY: 4 },
                              Je = null,
                              et = function () {
                                   if (null === Je)
                                        try {
                              ...
                              It = function (e, t) {
                                   ...
                                   return (
                                        ...
                                        j(t) || (t = gt()),
                                        t && null === r && ht(t) ? (i.name = t) : ((r = r || _t(i.type)), (i.name = t + (r ? '.' + r : ''))),
                                        i
                                   );
                              },
                              Tt = function () {
                                             ...
                                             e
                                                  ? ((t.timestamp = Date.now()),
                                                    (t.request = e(
                                                         ...
                                                         function (e) {
                                                              a.fire('error', 'string' == typeof e ? { type: 'error', code: 0, body: e } : e);
                                                         },
                                                         function (e, n, r) {
                                                         ...
                                                         function (e) {
                                                              ...
                                                              a.fire('meta', { size: t.size || n.size, filename: n.name, source: n.source });
                                                         }
                                                    )))
                                                  : a.fire('error', { type: 'error', body: "Can't load URL", code: 400 });
                                        },
                                        a = Object.assign({}, Me(), {
                              ...
                              Nt = function (e, t, n) {
                                   var r = {
                                        ...
                                        i = !1,
                                        o = !1;
                                   (n = Object.assign({ method: 'POST', headers: {}, withCredentials: !1 }, n)), (t = encodeURI(t)), Ct(n.method) && e && (t = '' + t + encodeURIComponent('string' == typeof e ? e : JSON.stringify(e)));
                                   var a = new XMLHttpRequest();
                                   return (
                                        ((Ct(n.method) ? a : a.upload).onprogress = function (e) {
                                        ...
                                        a.open(n.method, t, !0),
                                        Q(n.timeout) && (a.timeout = n.timeout),
                              ...
                              Bt = function () {
                                   ...
                                   return function (i, o, a, s, u, l) {
                                        var c = Nt(i, Ut(e, t.url), Object.assign({}, t, { responseType: 'blob' }));
                                        return (
                                             (c.onload = function (e) {
                              ...
                              Vt = { QUEUED: 0, COMPLETE: 1, PROCESSING: 2, ERROR: 3, WAITING: 4 },
                                   ...
                                   for (
                                        var f = [],
                                             ...
                                             T = function (o) {
                                                  ...
                                                  var u = 'function' == typeof t.headers ? t.headers(r, i) : Object.assign({}, t.headers, { 'Upload-Length': r.size }),
                                             ...
                                             v = function (n) {
                                                  var r = Ut(e, p.url, _.serverId),
                                                       i = { headers: 'function' == typeof t.headers ? t.headers(_.serverId) : Object.assign({}, t.headers), method: 'HEAD' },
                                                       o = Nt(null, r, i);
                                                  (o.onload = function (e) {
                                        ...
                                        f[R] = { index: R, size: A.size, offset: O, data: A, file: r, progress: 0, retries: Oe(h), status: Vt.QUEUED, error: null, request: null, timeout: null };
                                   }
                                   var D = function () {
                                             return o(_.serverId);
                                        },
                                             ...
                                             if (!_.aborted)
                                                  if ((t = t || f.find(S))) {
                                                       ...
                                                       var n =
                                                            ...
                                                            l = (t.request = Nt(n(t.data), o, Object.assign({}, p, { headers: s })));
                                                       (l.onload = function () {
                                                            ...
                                                            (l.onerror = function (e) {
                                                                 (t.status = Vt.ERROR),
                                                                      ...
                                                                      L(t) || a(Gt('error', e.status, i(e.response) || e.statusText, e.getAllResponseHeaders()));
                                                            }),
                                   ...
                                   return function (i, o, a, s, u, l, c) {
                                        if (i) {
                                             ...
                                             var E =
                                                  ...
                                                  g = Object.assign({}, t, { headers: m }),
                                                  I = new FormData();
                                             ie(o) && I.append(n, JSON.stringify(o)),
                                                  (i instanceof Blob ? [{ name: null, file: i }] : i).forEach(function (e) {
                                   ...
                                   var n = { complete: !1, perceivedProgress: 0, perceivedPerformanceUpdater: null, progress: null, timestamp: null, perceivedDuration: 0, duration: 0, request: null, response: null },
                                        ...
                                        i = function (t, i) {
                                             ...
                                             l.fire('start'),
                                                  ...
                                                  (n.perceivedPerformanceUpdater = jt(
                                                       function (e) {
                                                  ...
                                                  (n.request = e(
                                                       ...
                                                       i,
                                                       function (e) {
                                                            (n.response = ie(e) ? e : { type: 'load', code: 200, body: '' + e, headers: {} }),
                                                                 (n.duration = Date.now() - n.timestamp),
                                                                 (n.progress = 1),
                                                                 l.fire('load', n.response.body),
                                                                 (!r || (r && 1 === n.perceivedProgress)) && a();
                                                       },
                                                       function (e) {
                                                            n.perceivedPerformanceUpdater.clear(), l.fire('error', ie(e) ? e : { type: 'error', code: 0, body: '' + e });
                                                       },
                                                       function (e, t, r) {
                                        ...
                                        l = Object.assign({}, Me(), { process: i, abort: o, getProgress: s, getDuration: u, reset: a });
                                   return l;
                              },
                              Xt = function (e) {
                              ...
                              Zt = function (e) {
                                   ...
                                   return (
                                        e instanceof Blob || pt(e) ? (t[0] = e.name || gt()) : pt(e) ? ((t[1] = e.length), (t[2] = Rt(e))) : j(e) && ((t[0] = Et(e)), (t[1] = 0), (t[2] = 'application/octet-stream')),
                                   ...
                                   var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                                        ...
                                        v = function (e, t, n) {
                                             ...
                                             r.forEach(function (e) {
                                                  ...
                                                  JSON.stringify(a[o]) !== JSON.stringify(t) && ((a[o] = t), l('metadata-update', { key: i, value: s[i], silent: n }));
                                        },
                                        y = function (e) {
                                             return Kt(e ? s[e] : s);
                                        },
                              ...
                              tn = function (e, t, n, r, i, o) {
                                   var a = Nt(null, e, { method: 'GET', responseType: 'blob' });
                                   return (
                                        (a.onload = function (n) {
                              ...
                              cn = function (e, t) {
                                   return function () {
                                        var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                             ...
                                             l = Ze(e.items, r);
                                        l ? t(l, o, s, u || {}) : s({ error: Gt('error', 0, 'Item not found'), file: null });
                                   };
                              },
                              fn = function (e, t, n) {
                                   return {
                                        ...
                                        DID_SET_FILES: function (t) {
                                             ...
                                             o.forEach(function (t) {
                                                  ...
                                                  i.forEach(function (t, n) {
                                                       ...
                                                       }) || e('ADD_ITEM', Object.assign({}, t, { interactionMethod: ge.NONE, index: n }));
                                                  });
                                        },
                                        DID_UPDATE_ITEM_METADATA: function (r) {
                                             ...
                                             a.silent ||
                                                  ...
                                                  (n.itemUpdateTimeout = setTimeout(function () {
                                                       var r = en(n.items, i);
                                                       if (t('IS_ASYNC')) {
                                                            r.origin === xe.LOCAL && e('DID_LOAD_ITEM', { id: r.id, error: null, serverFileReference: r.source });
                                                            var s = function () {
                                                                      setTimeout(function () {
                                                                 ...
                                                                 u = function (e) {
                                                                      r.revert(zt(n.options.server.url, n.options.server.revert), t('GET_FORCE_REVERT'))
                                                                           .then(e ? s : function () {})
                                                                           .catch(function () {});
                                                                 },
                                                                 l = function (e) {
                                                       ...
                                                       ke('SHOULD_PREPARE_OUTPUT', !1, { item: r, query: t, action: o, change: a }).then(function (n) {
                                        ...
                                        SORT: function (r) {
                                             var i = r.compare;
                                             ln(n, i), e('DID_SORT_ITEMS', { items: t('GET_ACTIVE_ITEMS') });
                                        },
                                        ADD_ITEMS: function (n) {
                                             ...
                                             var p = t('GET_IGNORED_FILES'),
                                                  ...
                                                  h = r.filter(E).map(function (t) {
                                                       return new Promise(function (n, r) {
                                                            e('ADD_ITEM', { interactionMethod: o, source: t.source || t, success: n, failure: r, index: c++, options: t.options || {} });
                                                       });
                                                  });
                                        ...
                                        ADD_ITEM: function (r) {
                                             var i = r.source,
                                                  ...
                                                  d = r.options,
                                                  p = void 0 === d ? {} : d;
                                             if (q(i)) f({ error: Gt('error', 0, 'No source'), file: null });
                                                  ...
                                                  if (!lt(n)) {
                                                       if (n.options.allowMultiple || (!n.options.allowMultiple && !n.options.allowReplace)) {
                                                            ...
                                                            return e('DID_THROW_MAX_FILES', { source: i, error: E }), void f({ error: E, file: null });
                                                       }
                                                       var h = Ke(n.items)[0];
                                                       if (h.status === Ge.PROCESSING_COMPLETE || h.status === Ge.PROCESSING_REVERT_ERROR) {
                                                            ...
                                                            if (
                                                                 (h
                                                                      .revert(zt(n.options.server.url, n.options.server.revert), _)
                                                                      .then(function () {
                                                                           _ && e('ADD_ITEM', { source: i, index: a, interactionMethod: s, success: l, failure: f, options: p });
                                                                      })
                                                                      .catch(function () {}),
                                                                 _)
                                                            )
                                                  ...
                                                  Object.keys(p.metadata || {}).forEach(function (e) {
                                                       ...
                                                       Ye('DID_CREATE_ITEM', g, { query: t, dispatch: e });
                                                  ...
                                                  g.on('init', function () {
                                                       ...
                                                       g.on('load-progress', function (t) {
                                                            e('DID_UPDATE_ITEM_LOAD_PROGRESS', { id: T, progress: t });
                                                       }),
                                                       g.on('load-request-error', function (t) {
                                                            var r = on(n.options.labelFileLoadError)(t);
                                                            if (t.code >= 400 && t.code < 500)
                                                                 return e('DID_THROW_ITEM_INVALID', { id: T, error: t, status: { main: r, sub: t.code + ' (' + t.body + ')' } }), void f({ error: t, file: Ce(g) });
                                                            e('DID_THROW_ITEM_LOAD_ERROR', { id: T, error: t, status: { main: r, sub: n.options.labelTapToRetry } });
                                                       }),
                                                       g.on('load-file-error', function (t) {
                                                            e('DID_THROW_ITEM_INVALID', { id: T, error: t.status, status: t.status }), f({ error: t.status, file: Ce(g) });
                                                       }),
                                                       g.on('load-abort', function () {
                                                            e('REMOVE_ITEM', { query: T });
                                                       }),
                                                       g.on('load-skip', function () {
                                                            e('COMPLETE_LOAD_ITEM', { query: T, item: g, data: { source: i, success: l } });
                                                       }),
                                                       g.on('load', function () {
                                                            var r = function (r) {
                                                                 r
                                                                      ? (g.on('metadata-update', function (t) {
                                                                             e('DID_UPDATE_ITEM_METADATA', { id: T, change: t });
                                                                        }),
                                                                        ke('SHOULD_PREPARE_OUTPUT', !1, { item: g, query: t }).then(function (r) {
                                                                             var o = t('GET_BEFORE_PREPARE_FILE');
                                                                             o && (r = o(g, r));
                                                                             var a = function () {
                                                                                  e('COMPLETE_LOAD_ITEM', { query: T, item: g, data: { source: i, success: l } }), sn(e, n);
                                                                             };
                                                                             r
                                                                                  ? e(
                                                                                         'REQUEST_PREPARE_OUTPUT',
                                                                                         {
                                                                                              ...
                                                                                              item: g,
                                                                                              success: function (t) {
                                                                                                   e('DID_PREPARE_OUTPUT', { id: T, file: t }), a();
                                                                                              },
                                                                                         },
                                                                                         !0
                                                                                    )
                                                            ...
                                                            ke('DID_LOAD_ITEM', g, { query: t, dispatch: e })
                                                                 .then(function () {
                                                                      un(t('GET_BEFORE_ADD_FILE'), Ce(g)).then(r);
                                                                 })
                                                                 .catch(function (t) {
                                                                      if (!t || !t.error || !t.status) return r(!1);
                                                                      e('DID_THROW_ITEM_INVALID', { id: T, error: t.error, status: t.status });
                                                                 });
                                                       }),
                                                       ...
                                                       g.on('process-progress', function (t) {
                                                            e('DID_UPDATE_ITEM_PROCESS_PROGRESS', { id: T, progress: t });
                                                       }),
                                                       g.on('process-error', function (t) {
                                                            e('DID_THROW_ITEM_PROCESSING_ERROR', { id: T, error: t, status: { main: on(n.options.labelFileProcessingError)(t), sub: n.options.labelTapToRetry } });
                                                       }),
                                                       g.on('process-revert-error', function (t) {
                                                            e('DID_THROW_ITEM_PROCESSING_REVERT_ERROR', { id: T, error: t, status: { main: on(n.options.labelFileProcessingRevertError)(t), sub: n.options.labelTapToRetry } });
                                                       }),
                                                       g.on('process-complete', function (t) {
                                                            e('DID_COMPLETE_ITEM_PROCESSING', { id: T, error: null, serverFileReference: t }), e('DID_DEFINE_VALUE', { id: T, value: t });
                                                       }),
                                                       g.on('process-abort', function () {
                                                            e('DID_ABORT_ITEM_PROCESSING', { id: T });
                                                       }),
                                                       g.on('process-revert', function () {
                                                            e('DID_REVERT_ITEM_PROCESSING', { id: T }), e('DID_DEFINE_VALUE', { id: T, value: null });
                                                       }),
                                                       e('DID_ADD_ITEM', { id: T, index: a, interactionMethod: s }),
                                                       sn(e, n);
                                                  ...
                                                  g.load(i, bt(m === xe.INPUT ? (j(i) && rn(i) && A ? Bt(y, A) : tn) : m === xe.LIMBO ? Bt(y, O) : Bt(y, R)), function (e, n, r) {
                                                       ke('LOAD_FILE', e, { query: t }).then(n).catch(r);
                                                  });
                                             }
                                        },
                                        REQUEST_PREPARE_OUTPUT: function (e) {
                                             var n = e.item,
                                                  ...
                                                  i = e.failure,
                                                  o = void 0 === i ? function () {} : i,
                                                  a = { error: Gt('error', 0, 'Item not found'), file: null };
                                             if (n.archived) return o(a);
                                             ke('PREPARE_OUTPUT', n.file, { query: t, item: n }).then(function (e) {
                                                  ke('COMPLETE_PREPARE_OUTPUT', e, { query: t, item: n }).then(function (e) {
                                                       if (n.archived) return o(a);
                                                       r(e);
                                                  });
                                             });
                                        ...
                                        COMPLETE_LOAD_ITEM: function (r) {
                                             ...
                                             if (($(u) && s && ln(n, u), e('DID_LOAD_ITEM', { id: i.id, error: null, serverFileReference: i.origin === xe.INPUT ? null : s }), a(Ce(i)), i.origin !== xe.LOCAL))
                                                  return i.origin === xe.LIMBO
                                                       ? (e('DID_COMPLETE_ITEM_PROCESSING', { id: i.id, error: null, serverFileReference: s }), void e('DID_DEFINE_VALUE', { id: i.id, value: i.serverId || s }))
                                                       : void (t('IS_ASYNC') && n.options.instantUpload && e('REQUEST_ITEM_PROCESSING', { query: i.id }));
                                        ...
                                        REQUEST_ITEM_PROCESSING: cn(n, function (r, i, o) {
                                             if (r.status === Ge.IDLE || r.status === Ge.PROCESSING_ERROR)
                                                  r.status !== Ge.PROCESSING_QUEUED && (r.requestProcessing(), e('DID_REQUEST_ITEM_PROCESSING', { id: r.id }), e('PROCESS_ITEM', { query: r, success: i, failure: o }, !0));
                                             else {
                                                  var a = function () {
                                                            return e('REQUEST_ITEM_PROCESSING', { query: r, success: i, failure: o });
                                                       },
                                                       s = function () {
                                                            return document.hidden ? a() : setTimeout(a, 32);
                                                       };
                                                  r.status === Ge.PROCESSING_COMPLETE || r.status === Ge.PROCESSING_REVERT_ERROR
                                                       ? r
                                                              .revert(zt(n.options.server.url, n.options.server.revert), t('GET_FORCE_REVERT'))
                                                              .then(s)
                                                              .catch(function () {})
                                                       : r.status === Ge.PROCESSING && r.abortProcessing().then(s);
                                             }
                                        }),
                                                  ...
                                                  if (r.status !== Ge.PROCESSING) {
                                                       var s = function t() {
                                                            ...
                                                            if (r) {
                                                                 var i = r.id,
                                                                      ...
                                                                      a = r.failure,
                                                                      s = Ze(n.items, i);
                                                                 s && !s.archived ? e('PROCESS_ITEM', { query: i, success: o, failure: a }, !0) : t();
                                                            }
                                                       };
                                                       r.onOnce('process-complete', function () {
                                                            ...
                                                            r.onOnce('process-error', function (e) {
                                                                 o({ error: e, file: Ce(r) }), s();
                                                            });
                                                       var u = n.options;
                                                       r.process(
                                                            Ht(
                                                                 Yt(u.server.url, u.server.process, u.name, {
                                                            ...
                                                            function (n, i, o) {
                                                                 ke('PREPARE_OUTPUT', n, { query: t, item: r })
                                                                      .then(function (t) {
                                                                           e('DID_PREPARE_OUTPUT', { id: r.id, file: t }), i(t);
                                                                      })
                                                                      .catch(o);
                                                            }
                                                       );
                                        ...
                                        REMOVE_ITEM: cn(n, function (r, i, o, a) {
                                             var s = function () {
                                                       var t = r.id;
                                                       en(n.items, t).archive(), e('DID_REMOVE_ITEM', { error: null, id: t, item: r }), sn(e, n), i(Ce(r));
                                                  },
                                                  u = n.options.server;
                                             r.origin === xe.LOCAL && u && $(u.remove) && !1 !== a.remove
                                                  ? (e('DID_START_ITEM_REMOVE', { id: r.id }),
                                                    u.remove(
                                                         ...
                                                         function (t) {
                                                              e('DID_THROW_ITEM_REMOVE_ERROR', { id: r.id, error: Gt('error', 0, t, null), status: { main: on(n.options.labelFileRemoveError)(t), sub: n.options.labelTapToRetry } });
                                                         }
                                                    ))
                                                  : (((a.revert && r.origin !== xe.LOCAL && null !== r.serverId) || (n.options.chunkUploads && r.file.size > n.options.chunkSize) || (n.options.chunkUploads && n.options.chunkForce)) &&
                                                         r.revert(zt(n.options.server.url, n.options.server.revert), t('GET_FORCE_REVERT')),
                                                    s());
                                        }),
                                        ...
                                        REVERT_ITEM_PROCESSING: cn(n, function (r) {
                                             r.revert(zt(n.options.server.url, n.options.server.revert), t('GET_FORCE_REVERT'))
                                                  .then(function () {
                                                       (n.options.instantUpload || an(r)) && e('REMOVE_ITEM', { query: r.id });
                                                  })
                                                  .catch(function () {});
                                        }),
                                        SET_OPTIONS: function (t) {
                                             ...
                                             []
                                                  ...
                                                  .forEach(function (t) {
                                                       e('SET_' + Ee(t, '_').toUpperCase(), { value: n[t] });
                                                  });
                                        },
                                   };
                              },
                              ...
                              gn = function (e, t, n, r, i) {
                                   var o = 1;
                                   return i > r && i - r <= 0.5 && (o = 0), r > i && r - i >= 0.5 && (o = 0), mn(e, t, n, 360 * Math.min(0.9999, r), 360 * Math.min(0.9999, i), o);
                              },
                              In = G({
                                   tag: 'div',
                                   ...
                                   create: function (e) {
                                        ...
                                        var r = c('svg');
                                        (t.ref.path = c('path', { 'stroke-width': 2, 'stroke-linecap': 'round' })), r.appendChild(t.ref.path), (t.ref.svg = r), t.appendChild(r);
                                   },
                                   write: function (e) {
                                        var t = e.root,
                                             n = e.props;
                                        if (0 !== n.opacity) {
                                             ...
                                             var r = parseInt(a(t.ref.path, 'stroke-width'), 10),
                                                  ...
                                                  o = 0,
                                                  s = 0;
                                             n.spin ? ((o = 0), (s = 0.5)) : ((o = 0), (s = n.progress));
                              ...
                              An = function (e) {
                                   var t = e.root,
                                        n = e.props;
                                   Q(t.query('GET_ITEM_SIZE', n.id)) ? On({ root: t, props: n }) : hn(t.ref.fileSize, t.query('GET_LABEL_FILE_SIZE_NOT_AVAILABLE'));
                              },
                              Dn = G({
                                   name: 'file-info',
                                   ignoreRect: !0,
                                   ignoreRectUpdate: !0,
                                   write: F({ DID_LOAD_ITEM: On, DID_UPDATE_ITEM_META: On, DID_THROW_ITEM_LOAD_ERROR: An, DID_THROW_ITEM_INVALID: An }),
                              ...
                              wn = function (e) {
                                   ...
                                   var r = En('span');
                                   (r.className = 'filepond--file-status-sub'), t.appendChild(r), (t.ref.sub = r), Ln({ root: t, action: { progress: null } });
                              },
                              Ln = function (e) {
                                   var t = e.root,
                                        n = e.action,
                         ...
                         var Gn,
                              ...
                              kn = { buttonRemoveItem: { opacity: 1 }, buttonProcessItem: { opacity: 1 }, info: { translateX: xn }, status: { translateX: xn } },
                              Yn = { buttonAbortItemProcessing: { opacity: 1 }, processProgressIndicator: { opacity: 1 }, status: { opacity: 1 } },
                              zn = {
                                   DID_THROW_ITEM_INVALID: { buttonRemoveItem: { opacity: 1 }, info: { translateX: xn }, status: { translateX: xn, opacity: 1 } },
                                   DID_START_ITEM_LOAD: { buttonAbortItemLoad: { opacity: 1 }, loadProgressIndicator: { opacity: 1 }, status: { opacity: 1 } },
                                   DID_THROW_ITEM_LOAD_ERROR: { buttonRetryItemLoad: { opacity: 1 }, buttonRemoveItem: { opacity: 1 }, info: { translateX: xn }, status: { opacity: 1 } },
                                   DID_START_ITEM_REMOVE: { processProgressIndicator: { opacity: 1, align: Vn }, info: { translateX: xn }, status: { opacity: 0 } },
                                   DID_THROW_ITEM_REMOVE_ERROR: { processProgressIndicator: { opacity: 0, align: Vn }, buttonRemoveItem: { opacity: 1 }, info: { translateX: xn }, status: { opacity: 1, translateX: xn } },
                                   DID_LOAD_ITEM: kn,
                                   DID_LOAD_LOCAL_ITEM: { buttonRemoveItem: { opacity: 1 }, info: { translateX: xn }, status: { translateX: xn } },
                                   ...
                                   DID_THROW_ITEM_PROCESSING_ERROR: { buttonRemoveItem: { opacity: 1 }, buttonRetryItemProcessing: { opacity: 1 }, status: { opacity: 1 }, info: { translateX: xn } },
                                   DID_THROW_ITEM_PROCESSING_REVERT_ERROR: { buttonRevertItemProcessing: { opacity: 1 }, status: { opacity: 1 }, info: { opacity: 1 } },
                                   DID_ABORT_ITEM_PROCESSING: { buttonRemoveItem: { opacity: 1 }, buttonProcessItem: { opacity: 1 }, info: { translateX: xn }, status: { opacity: 1 } },
                              ...
                              jn = function (e) {
                                   ...
                                   if ((c && s && ((o.RevertItemProcessing.label = 'GET_LABEL_BUTTON_REMOVE_ITEM'), (o.RevertItemProcessing.icon = 'GET_ICON_REMOVE')), f && !s)) {
                                        ...
                                        (E.info.translateX = Bn), (E.info.translateY = Un), (E.status.translateY = Un), (E.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 });
                                   }
                                   if (
                                        (f &&
                                             !l &&
                                             ...
                                             (zn.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = Fn)),
                                        d && s)
                                   ) {
                                        o.RevertItemProcessing.align = 'BUTTON_REMOVE_ITEM_POSITION';
                                        var h = zn.DID_COMPLETE_ITEM_PROCESSING;
                                        (h.info.translateX = xn), (h.status.translateY = Un), (h.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 });
                                   }
                                   u || (o.RemoveItem.disabled = !0),
                                        i(o, function (e, t) {
                                             var r = n.createChildView(Tn, { label: n.query(t.label), icon: n.query(t.icon), opacity: 0 });
                                             p.includes(e) && n.appendChildView(r),
                                                  t.disabled && (r.element.setAttribute('disabled', 'disabled'), r.element.setAttribute('hidden', 'hidden')),
                                                  (r.element.dataset.align = n.query('GET_STYLE_' + t.align)),
                                                  r.element.classList.add(t.className),
                                                  r.on('click', function (e) {
                                                       e.stopPropagation(), t.disabled || n.dispatch(t.action, { query: a });
                                                  }),
                                                  (n.ref['button' + e] = r);
                                        }),
                                        (n.ref.processingCompleteIndicator = n.appendChildView(n.createChildView(Wn))),
                                        (n.ref.processingCompleteIndicator.element.dataset.align = n.query('GET_STYLE_BUTTON_PROCESS_ITEM_POSITION')),
                                        (n.ref.info = n.appendChildView(n.createChildView(Dn, { id: a }))),
                                        (n.ref.status = n.appendChildView(n.createChildView(bn, { id: a })));
                                   var _ = n.appendChildView(n.createChildView(In, { opacity: 0, align: n.query('GET_STYLE_LOAD_INDICATOR_POSITION') }));
                                   _.element.classList.add('filepond--load-indicator'), (n.ref.loadProgressIndicator = _);
                                   var m = n.appendChildView(n.createChildView(In, { opacity: 0, align: n.query('GET_STYLE_PROGRESS_INDICATOR_POSITION') }));
                                   ...
                                   if (o) {
                                        ...
                                        i(qn, function (e, n) {
                                             ...
                                             i(n, function (n, i) {
                                                  ...
                                                  t.ref.activeStyles.push({ control: r, key: n, value: o });
                                             });
                                        });
                                   }
                              ...
                              Qn = G({
                                   create: function (e) {
                                        var t = e.root,
                                             n = e.props;
                                        (t.ref.fileName = En('legend')), t.appendChild(t.ref.fileName), (t.ref.file = t.appendChildView(t.createChildView(Zn, { id: n.id }))), (t.ref.data = !1);
                                   },
                                   ignoreRect: !0,
                                   write: F({
                              ...
                              Kn = { type: 'spring', damping: 0.6, mass: 7 },
                              $n = function (e) {
                                   var t = e.root,
                                        n = e.props;
                                   [
                                        { name: 'top' },
                                        { name: 'center', props: { translateY: null, scaleY: null }, mixins: { animations: { scaleY: Kn }, styles: ['translateY', 'scaleY'] } },
                                        { name: 'bottom', props: { translateY: null }, mixins: { animations: { translateY: Kn }, styles: ['translateY'] } },
                                   ].forEach(function (e) {
                                        Jn(t, e, n.name);
                                   }),
                              ...
                              Jn = function (e, t, n) {
                                   var r = G({ name: 'panel-' + t.name + ' filepond--' + n, mixins: t.mixins, ignoreRectUpdate: !0 }),
                              ...
                              nr = { type: 'spring', stiffness: 0.75, damping: 0.45, mass: 10 },
                              rr = 'spring',
                              ir = {
                              ...
                              or = function (e) {
                                   ...
                                   if (
                                        ...
                                        (t.ref.container = t.appendChildView(t.createChildView(Qn, { id: n.id }))),
                                        (t.ref.panel = t.appendChildView(t.createChildView(er, { name: 'item-panel' }))),
                                        ...
                                        var r = function (e) {
                                             if (e.isPrimary) {
                                                  ...
                                                  t.dispatch('DID_GRAB_ITEM', { id: n.id, dragState: o });
                                                  var a = function (e) {
                                                            e.isPrimary &&
                                                                 (e.stopPropagation(),
                                                                 e.preventDefault(),
                                                                 (n.dragOffset = { x: e.pageX - i.x, y: e.pageY - i.y }),
                                                                 ...
                                                                 t.dispatch('DID_DRAG_ITEM', { id: n.id, dragState: o }));
                                                       },
                                                       s = function e(s) {
                                                            s.isPrimary &&
                                                                 (document.removeEventListener('pointermove', a),
                                                                 document.removeEventListener('pointerup', e),
                                                                 (n.dragOffset = { x: s.pageX - i.x, y: s.pageY - i.y }),
                                                                 t.dispatch('DID_DROP_ITEM', { id: n.id, dragState: o }),
                                                                 r &&
                                                                      setTimeout(function () {
                              ...
                              sr = F(
                                   ...
                                   function (e) {
                                        ...
                                        a ? i || (t.height = t.rect.element.width * a) : (ar({ root: t, actions: n, props: r }), !t.height && t.ref.container.rect.element.height > 0 && (t.height = t.ref.container.rect.element.height)),
                              ...
                              ur = G({
                                   ...
                                   mixins: {
                                        ...
                                        animations: { scaleX: rr, scaleY: rr, translateX: nr, translateY: nr, opacity: { type: 'tween', duration: 150 } },
                                   },
                              }),
                              lr = function (e, t) {
                              ...
                              pr = function (e, t, n) {
                                   ...
                                   e.dragOffset
                                        ...
                                        : ((e.translateX = t), (e.translateY = n), Date.now() > e.spawnDate && (0 === e.opacity && Er(e, t, n, r, i), (e.scaleX = 1), (e.scaleY = 1), (e.opacity = 1)));
                              },
                              Er = function (e, t, n, r, i) {
                                   e.interactionMethod === ge.NONE
                                        ? ((e.translateX = null), (e.translateX = t), (e.translateY = null), (e.translateY = n))
                                        : e.interactionMethod === ge.DROP
                                        ? ((e.translateX = null), (e.translateX = t - 20 * r), (e.translateY = null), (e.translateY = n - 10 * i), (e.scaleX = 0.8), (e.scaleY = 0.8))
                                        : e.interactionMethod === ge.BROWSE
                                        ? ((e.translateY = null), (e.translateY = n - 30))
                                        : e.interactionMethod === ge.API && ((e.translateX = null), (e.translateX = t - 30), (e.translateY = null));
                              },
                              hr = function (e) {
                                   return e.rect.element.height + 0.5 * e.rect.element.marginBottom + 0.5 * e.rect.element.marginTop;
                              },
                              _r = function (e) {
                                   return e.rect.element.width + 0.5 * e.rect.element.marginLeft + 0.5 * e.rect.element.marginRight;
                              },
                              mr = F({
                                   DID_ADD_ITEM: function (e) {
                                        ...
                                        (t.ref.lastItemSpanwDate = s), t.appendChildView(t.createChildView(ur, { spawnDate: s, id: r, opacity: u, interactionMethod: o }), i);
                                   },
                                   ...
                                   DID_DRAG_ITEM: function (e) {
                                        var t = e.root,
                                             ...
                                             u = i.getItemIndex(o);
                                        if (a) {
                                             var l = { x: a.dragOrigin.x + a.dragOffset.x + a.dragCenter.x, y: a.dragOrigin.y + a.dragOffset.y + a.dragCenter.y },
                                                  c = hr(a),
                                                  f = _r(a),
                                             ...
                                             if (void 0 === _ || _ !== h) {
                                                  ...
                                                  t.dispatch('DID_REORDER_ITEMS', { items: t.query('GET_ACTIVE_ITEMS'), origin: u, target: h });
                                             }
                                        }
                                   },
                              }),
                                        ...
                                        if (0 !== u.length) {
                                             ...
                                             if (1 === I) {
                                                  ...
                                                  u.forEach(function (e, t) {
                                                       if (l) {
                                                            var n = t - l;
                                                            v = -2 === n ? 0.25 * -h : -1 === n ? 0.75 * -h : 0 === n ? 0.75 * h : 1 === n ? 0.25 * h : 0;
                                                       }
                              ...
                              Or = function (e) {
                                   ...
                                   (t.element.id = 'filepond--browser-' + n.id),
                                        ...
                                        a(t.element, 'aria-controls', 'filepond--assistant-' + n.id),
                                        a(t.element, 'aria-labelledby', 'filepond--drop-label-' + n.id),
                                        Ar({ root: t, action: { value: t.query('GET_ACCEPTED_FILE_TYPES') } }),
                                        Dr({ root: t, action: { value: t.query('GET_ALLOW_MULTIPLE') } }),
                                        Sr({ root: t, action: { value: t.query('GET_ALLOW_DIRECTORIES_ONLY') } }),
                                        wr({ root: t }),
                                        Lr({ root: t, action: { value: t.query('GET_REQUIRED') } }),
                                        Mr({ root: t, action: { value: t.query('GET_CAPTURE_METHOD') } }),
                              ...
                              Pr = function (e) {
                                   ...
                                   t.query('GET_TOTAL_ITEMS') > 0
                                        ? (yr(n, 'required', !1), yr(n, 'name', !1))
                                        : (yr(n, 'name', !0, t.query('GET_NAME')), t.query('GET_CHECK_VALIDITY') && n.setCustomValidity(''), t.query('GET_REQUIRED') && yr(n, 'required', !0));
                              },
                              br = G({
                                   tag: 'input',
                                   name: 'browser',
                              ...
                              Nr = function (e) {
                                   ...
                                   a(r, 'for', 'filepond--browser-' + n.id),
                                        ...
                                        r.addEventListener('keydown', t.ref.handleKeyDown),
                                        t.element.addEventListener('click', t.ref.handleClick),
                                        Gr(r, n.caption),
                                        t.appendChild(r),
                                        (t.ref.label = r);
                              ...
                              Ur = function (e) {
                                   ...
                                   t.ref.blob = t.appendChildView(t.createChildView(Fr, { opacity: 0, scaleX: 2.5, scaleY: 2.5, translateX: n, translateY: r }));
                              },
                              Br = function (e) {
                                   var t = e.root,
                                        n = e.props,
                                        r = e.actions;
                                   Vr({ root: t, props: n, actions: r });
                                   var i = t.ref.blob;
                              ...
                              qr = G({ ignoreRect: !0, ignoreRectUpdate: !0, name: 'drip', write: Br }),
                              kr = function (e, t) {
                                   try {
                              ...
                              Xr = G({ tag: 'fieldset', name: 'data', create: Yr, write: Hr, ignoreRect: !0 }),
                              Zr = function (e) {
                                   return 'getRootNode' in e ? e.getRootNode() : document;
                              },
                              Qr = ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'webp', 'svg', 'tiff'],
                              Kr = ['css', 'csv', 'html', 'txt'],
                              $r = { zip: 'zip|compressed', epub: 'application/epub+zip' },
                              Jr = function () {
                                   var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '';
                              ...
                              hi = function (e, t, n) {
                                   var r = _i(t),
                                        i = { element: e, filterElement: n, state: null, ondrop: function () {}, onenter: function () {}, ondrag: function () {}, onexit: function () {}, onload: function () {}, allowdrop: function () {} };
                              ...
                              mi = function (e) {
                                   var t = [],
                                        n = { dragenter: yi, dragover: Ri, dragleave: Ai, drop: Oi },
                                        r = {};
                                   i(n, function (n, i) {
                              ...
                              Ii = function (e, t) {
                                   var n = Zr(t),
                                        r = gi(n, { x: e.pageX - window.pageXOffset, y: e.pageY - window.pageYOffset });
                              ...
                              Ui = function (e, t, n) {
                                   ...
                                   xi(e, n + ' ' + t + ', ' + r + ' ' + (1 === r ? e.query('GET_LABEL_FILE_COUNT_SINGULAR') : e.query('GET_LABEL_FILE_COUNT_PLURAL'))),
                                        clearTimeout(Ni),
                              ...
                              Hi = function (e) {
                                   ...
                                   i &&
                                        ...
                                        (t.ref.label = t.appendChildView(t.createChildView(xr, Object.assign({}, n, { translateY: null, caption: t.query('GET_LABEL_IDLE') })))),
                                        (t.ref.list = t.appendChildView(t.createChildView(vr, { translateY: null }))),
                                        (t.ref.panel = t.appendChildView(t.createChildView(er, { name: 'panel-root' }))),
                                        (t.ref.assistant = t.appendChildView(t.createChildView(ki, Object.assign({}, n)))),
                                        (t.ref.data = t.appendChildView(t.createChildView(Xr, Object.assign({}, n)))),
                                        (t.ref.measure = En('div')),
                                        ...
                                        (t.ref.widthUpdated = zi(function () {
                                   ...
                                   t.query('GET_ALLOW_REORDER') && a && !o && (t.element.addEventListener('touchmove', ji, { passive: !1 }), t.element.addEventListener('gesturestart', ji));
                              ...
                              Xi = function (e) {
                                   ...
                                   if (
                                        ...
                                        if (((u.translateY = Math.max(0, I - u.rect.element.marginTop) - _.top), c)) {
                                             ...
                                             D.push(O);
                                             var S = 2;
                                             if (D.length > 2 * S) for (var w = D.length, L = w - 10, M = 0, P = w; P >= L; P--) if ((D[P] === D[P - 2] && M++, M >= S)) return;
                              ...
                              $i = function (e, t) {
                                   var n = e.query('GET_ALLOW_REPLACE'),
                                        ...
                                        a = t.length;
                                   return (!r && a > 1) || (!!(Q((o = r || n ? o : 1)) && i + a > o) && (e.dispatch('DID_THROW_MAX_FILES', { source: t, error: Gt('warning', 0, 'Max files') }), !0));
                              },
                              Ji = function (e, t, n) {
                                   var r = e.childViews[0];
                                   return cr(r, t, { left: n.scopeLeft - r.rect.element.left, top: n.scopeTop - (e.rect.outer.top + e.rect.element.marginTop + e.rect.element.scrollTop) });
                              },
                              eo = function (e) {
                                   ...
                                   if (r && !e.ref.hopper) {
                                        ...
                                        (i.onload = function (t, n) {
                                             ...
                                             ke('ADD_ITEMS', t, { dispatch: e.dispatch }).then(function (t) {
                                                  if ($i(e, t)) return !1;
                                                  e.dispatch('ADD_ITEMS', { items: t, index: Ji(e.ref.list, i, n), interactionMethod: ge.DROP });
                                             }),
                                             ...
                                             (e.ref.hopper = i),
                                             (e.ref.drip = e.appendChildView(e.createChildView(qr)));
                                               ...
                                               e.createChildView(
                                                    ...
                                                    Object.assign({}, t, {
                                                         onload: function (t) {
                                                              ke('ADD_ITEMS', t, { dispatch: e.dispatch }).then(function (t) {
                                                                   if ($i(e, t)) return !1;
                                                                   e.dispatch('ADD_ITEMS', { items: t, index: -1, interactionMethod: ge.BROWSE });
                                                              });
                                                         },
                                                    })
                                               ),
                                   ...
                                   r && !e.ref.paster
                                        ? ((e.ref.paster = bi()),
                                          (e.ref.paster.onload = function (t) {
                                               ke('ADD_ITEMS', t, { dispatch: e.dispatch }).then(function (t) {
                                                    if ($i(e, t)) return !1;
                                                    e.dispatch('ADD_ITEMS', { items: t, index: -1, interactionMethod: ge.PASTE });
                                               });
                                          }))
                                   ...
                                   var p = io(i, { id: Ie() }),
                                        ...
                                        _ = {
                                             _read: function () {
                                                  u && ((f = window.innerWidth), c || (c = f), l || f === c || (i.dispatch('DID_START_RESIZE'), (l = !0))),
                                                       h && E && (E = null === p.element.offsetParent),
                                                       E || (p._read(), (h = p.rect.element.hidden));
                                             },
                                             _write: function (e) {
                                        ...
                                        m = function (e) {
                                             return function (t) {
                                                  var n = { type: e };
                                                  if (!t) return n;
                                                  if ((t.hasOwnProperty('error') && (n.error = t.error ? Object.assign({}, t.error) : null), t.status && (n.status = Object.assign({}, t.status)), t.file && (n.output = t.file), t.source))
                                                       n.file = t.source;
                                                  else if (t.item || t.id) {
                                                  ...
                                                  return (
                                                       t.items && (n.items = t.items.map(Ce)),
                                        ...
                                        A = function (e) {
                                             var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                             return new Promise(function (n, r) {
                                                  w([{ source: e, options: t }], { index: t.index })
                                                       .then(function (e) {
                                                            return n(e && e[0]);
                                                       })
                                                       .catch(r);
                                        ...
                                        S = function (e, t) {
                                             return 'object' != typeof e || D(e) || t || ((t = e), (e = void 0)), i.dispatch('REMOVE_ITEM', Object.assign({}, t, { query: e })), null === i.query('GET_ACTIVE_ITEM', e);
                                        },
                                        w = function () {
                                             ...
                                             return new Promise(function (e, n) {
                                                  ...
                                                  i.dispatch('ADD_ITEMS', { items: r, index: o.index, interactionMethod: ge.API, success: e, failure: n });
                                             });
                                        },
                                        L = function () {
                              ...
                              fo = function (e) {
                                   var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                                        n = {
                                             ...
                                             '^server': {
                                                  group: 'server',
                                                  mapping: { '^process': { group: 'process' }, '^revert': { group: 'revert' }, '^fetch': { group: 'fetch' }, '^restore': { group: 'restore' }, '^load': { group: 'load' } },
                                             },
                                             '^type$': !1,
                                             '^files$': !1,
                                        };
                         ...
                         if (
                              ...
                              var Go = function t() {
                                   document.dispatchEvent(
                                        new CustomEvent('FilePond:loaded', { detail: { supported: Po, create: e.create, destroy: e.destroy, parse: e.parse, find: e.find, registerPlugin: e.registerPlugin, setOptions: e.setOptions } })
                                   ),
                              ...
                              (e.Status = Object.assign({}, $e)),
                                   (e.FileOrigin = Object.assign({}, xe)),
                                   (e.FileStatus = Object.assign({}, Ge)),
                                   (e.OptionTypes = {}),
                                   xo(),
                                   (e.create = function () {
                                   ...
                                   (e.parse = function (t) {
                                        return Array.from(t.querySelectorAll('.' + Co))
                                             .filter(function (e) {
                         ...
                         (n = function (e) {
                              ...
                              return (
                                   ...
                                   (t.lib = t.prototype =
                                        {
                                             ...
                                             init: function (e) {
                                                  return (
                                                       ...
                                                       (this.options.style.background = t.defaults.backgroundColor || e.backgroundColor),
                                                       this
                                                  );
                                             },
                                             buildToast: function () {
                                                  ...
                                                  (e.className = 'toastify on ' + this.options.className),
                                                       this.options.position
                                                            ...
                                                            ? ((e.className += ' toastify-left'), console.warn('Property `positionLeft` will be depreciated in further versions. Please use `position` instead.'))
                                                  ...
                                                  if (this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE) e.appendChild(this.options.node);
                                                       ...
                                                       (t.src = this.options.avatar),
                                                            (t.className = 'toastify-avatar'),
                                                            'left' == this.options.position || !0 === this.options.positionLeft ? e.appendChild(t) : e.insertAdjacentElement('afterbegin', t);
                                                  }
                                   ...
                                   (t.reposition = function () {
                                        for (var e, t = { top: 15, bottom: 15 }, n = { top: 15, bottom: 15 }, i = { top: 15, bottom: 15 }, o = document.getElementsByClassName('toastify'), a = 0; a < o.length; a++) {
                                             ...
                                             (e = e.substr(9, e.length - 1)),
                                                  (window.innerWidth > 0 ? window.innerWidth : screen.width) <= 360
                                                       ? ((o[a].style[e] = i[e] + 'px'), (i[e] += s + 15))
                                                       : !0 === r(o[a], 'toastify-left')
                                                       ? ((o[a].style[e] = t[e] + 'px'), (t[e] += s + 15))
                                                       : ((o[a].style[e] = n[e] + 'px'), (n[e] += s + 15));
                                        }
                                        return this;
                                   }),
     ...
     (n.n = (e) => {
          ...
          (() => {
               ...
               r.registerPlugin(o(), s(), l(), f(), p(), h(), m()),
                    r.create(document.querySelector('.basic-filepond'), { credits: null, allowImagePreview: !1, allowMultiple: !1, allowFileEncode: !1, required: !1 }),
                    r.create(document.querySelector('.multiple-files-filepond'), { credits: null, allowImagePreview: !1, allowMultiple: !0, allowFileEncode: !1, required: !1 }),
                    ...
                    r.create(document.querySelector('.imgbb-filepond'), {
                         ...
                         server: {
                              process: function (e, n, r, i, o, a, s) {
                                   ...
                                   l.open('POST', 'https://api.imgbb.com/1/upload?key=762894e2014f83c023b233b2f10395e2'),
                                        ...
                                        (l.onreadystatechange = function () {
                                             if (4 == this.readyState)
                                                  if (200 == this.status) {
                                                       ...
                                                       t()({ text: 'Success uploading to imgbb! see console f12', duration: 3e3, close: !0, gravity: 'bottom', position: 'right', backgroundColor: '#4fbe87' }).showToast(), console.log(e);
                                                  } else
                                                       t()({ text: 'Failed uploading to imgbb! see console f12', duration: 3e3, close: !0, gravity: 'bottom', position: 'right', backgroundColor: '#ff0000' }).showToast(),
                    ...
                    r.create(document.querySelector('.image-filter-filepond'), {
                         ...
                         allowImageExifOrientation: !1,
                         allowImageCrop: !1,
                         imageFilterColorMatrix: [0.299, 0.587, 0.114, 0, 0, 0.299, 0.587, 0.114, 0, 0, 0.299, 0.587, 0.114, 0, 0, 0, 0, 0, 1, 0],
                         acceptedFileTypes: ['image/png', 'image/jpg', 'image/jpeg'],
                         fileValidateTypeDetectType: function (e, t) {
                              return new Promise(function (e, n) {
                                   e(t);
