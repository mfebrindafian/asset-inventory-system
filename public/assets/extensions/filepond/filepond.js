     ...
     var actions = function actions(dispatch, query, state) {
          return {
               ...
               ADD_ITEM: function ADD_ITEM(_ref7) {
                    ...
                    if (!hasRoomForItem(state)) {
                         ...
                         if (_item.status === ItemStatus.PROCESSING_COMPLETE || _item.status === ItemStatus.PROCESSING_REVERT_ERROR) {
                              ...
                              _item.revert(createRevertFunction(state.options.server.url, state.options.server.revert), forceRevert)
                                   .then(function () {
                    ...
                    item.load(
                         ...
                         function (file, success, error) {
                              ...
                              applyFilterChain('LOAD_FILE', file, { query: query }).then(success).catch(error);
                         }
                    );
               },
               ...
               REQUEST_PREPARE_OUTPUT: function REQUEST_PREPARE_OUTPUT(_ref9) {
                    ...
                    applyFilterChain('PREPARE_OUTPUT', item.file, { query: query, item: item }).then(function (result) {
