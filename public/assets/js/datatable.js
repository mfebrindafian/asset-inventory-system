...
!(function (n) {
     ...
     function Z(t) {
          ...
          a && Me(a),
               t &&
                    ((e = t.sZeroRecords),
                    !t.sEmptyTable && e && 'Maaf, data tidak tersedia' === n.sEmptyTable && F(t, t, 'sZeroRecords', 'sEmptyTable'),
     ...
     function le(t) {
          for (var e = t.aoColumns, n = I(t), a = t.oLanguage.oAria, r = 0, o = e.length; r < o; r++) {
               ...
               u.removeAttribute('aria-sort'),
                    (i = i.bSortable
                         ? s + ('asc' === ((0 < n.length && n[0].col == r && (u.setAttribute('aria-sort', 'asc' == n[0].dir ? 'ascending' : 'descending'), l[n[0].index + 1])) || l[0]) ? a.sSortAscending : a.sSortDescending)
                         : s),
               ...
               e('row().data()', function (t) {
                    ...
                    return t === H
                         ? n.length && this.length
                              ...
                              : H
                         : (((e = n[0].aoData[this[0]])._aData = t), Array.isArray(t) && e.nTr && e.nTr.id && b(n[0].rowId)(t, e.nTr.id), bt(n[0], this[0], 'data'), this);
               }),
               e('row().node()', function () {
                    var t = this.context;
