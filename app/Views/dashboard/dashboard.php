...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Dashboard</h3>
            <p class="text-subtitle text-muted">Rekap data inventarisasi barang milik negara di Universitas Jambi <?php if (session('level_id') == 3) {
                                                                                                                        echo 'Pada ' . $nama_satker;
                                                                                                                    } ?> <span class="satker-apa"></span></p>
        </div>
                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    ...
                                    <?php if (session('level_id') == 3) : ?>
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="<?= base_url('/list-bmn-dashboard/sudah/' . $akun['id'] . '/' . session('satker_id')) ?>" class="badge bg-light-success pt-3 w-100">
                                                    <h6 class="text-wrap">Sudah diproses</h6>
                                                    <h1 class="my-4 sudah text-truncate"><?= $data_bmn['sudah'][$ke]; ?></h1>
                                                </a>
                                            </div>
                                            <div class="col-6">
                                                <a href="<?= base_url('/list-bmn-dashboard/belum/' . $akun['id'] . '/' . session('satker_id')) ?>" class="badge bg-light-danger pt-3 w-100">
                                                    <h6 class="text-wrap">Belum diproses</h6>
                                                    <h1 class="my-4 belum text-truncate"><?= $data_bmn['belum'][$ke]; ?></h1>
                                                </a>
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <a href="<?= base_url('/list-bmn-dashboard/semua/' . $akun['id'] . '/' . session('satker_id')) ?>" class="btn btn-outline-primary w-100">Detail</a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
